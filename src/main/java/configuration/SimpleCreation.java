...
public class SimpleCreation {
    public static void main(String[] args) throws ExecutionException, InterruptedException {
        ...
        topics.add(new NewTopic("topic1",partitions,replicationFactor));
        topics.add(new NewTopic("topic2",partitions,replicationFactor));
        topics.add(new NewTopic("topic3",partitions,replicationFactor));
        topics.add(new NewTopic("topic4",partitions,replicationFactor));
        mongoClient.close();
//        try {
